...
import (
	...
	btHelpers "github.com/grafana/metrictank/bigtable"
...
func (b *BigtableIdx) InitBare() error {
	...
	err = btHelpers.EnsureTableExists(ctx, b.cfg.CreateCF, adminClient, b.cfg.TableName, map[string]bigtable.GCPolicy{
